...
/**
 * TTL 74x175 quadruple D-type flip-flops with asynchronous reset
 * Model based on < href="https://www.ti.com/lit/ds/symlink/sn74ls175.pdf">74LS175 datasheet</a>.
 */
public class Ttl74175 extends AbstractTtlGate {
  ...
  private void drawFlops(Graphics g, int x, int y, int height) {
    ...
    // dff1
    Drawgates.paintFlipFlop(g, x + 60, y, true, false, true);
    Drawgates.paintOutputgate(g, x + 30, y, x + 57, y + 37, false, height);
    Drawgates.paintOutputgate(g, x + 50, y, x + 55, y + 41, false, height);
    Drawgates.paintSingleInputgate(g, x + 70, y, x + 63, y + 37, false, height);
    ...
    // dff2
    Drawgates.paintFlipFlop(g, x + 100, y, true, false, false);
    Drawgates.paintOutputgate(g, x + 130, y, x + 103, y + 37, false, height);
    Drawgates.paintOutputgate(g, x + 110, y, x + 105, y + 41, false, height);
    Drawgates.paintSingleInputgate(g, x + 90, y, x + 97, y + 37, false, height);
    ...
    // dff3
    Drawgates.paintFlipFlop(g, x + 100, y, true, true, false);
    Drawgates.paintOutputgate(g, x + 130, y, x + 103, y + 23, true, height);
    Drawgates.paintOutputgate(g, x + 110, y, x + 105, y + 19, true, height);
    Drawgates.paintSingleInputgate(g, x + 90, y, x + 97, y + 23, true, height);
    ...
    // dff4
    Drawgates.paintFlipFlop(g, x + 60, y, true, true, true);
    Drawgates.paintOutputgate(g, x + 30, y, x + 57, y + 23, true, height);
    Drawgates.paintOutputgate(g, x + 50, y, x + 55, y + 19, true, height);
    Drawgates.paintSingleInputgate(g, x + 70, y, x + 63, y + 23, true, height);
